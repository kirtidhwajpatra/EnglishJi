            ...
            VStack(spacing: 24) {
                ...
                HStack(spacing: 6) {
                    ForEach(0..<5) { index in
                        Rectangle()
                            .fill(index < 2 ? Color(hex: "#110037") : Color.black.opacity(0.2))
                            .frame(height: 4)
                            .cornerRadius(2)
                    }
                }
                ...
                // MARK: - AGE Selector
                VStack {
                    EnhancedProfilePictureScreen(userAge: 32)
...
#Preview {
    Screen05_NameView(manager: OnboardingManager())
}
